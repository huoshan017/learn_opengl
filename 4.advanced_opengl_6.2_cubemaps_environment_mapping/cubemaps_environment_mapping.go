...
func main() {
	...
	// -------------------------------------
	var shader = gl.NewShader("6.2.cubemaps.vs", "6.2.cubemaps.fs")
	var skyboxShader = gl.NewShader("6.2.skybox.vs", "6.2.skybox.fs")
	...
	for !window.ShouldClose() {
		...
		shader.SetVec3("cameraPos\x00", &cameraPos)
