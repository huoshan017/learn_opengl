...
func main() {
	...
	// -------------------------------------
	var shader = gl.NewShader("6.1.coordinate_systems.vs", "6.1.coordinate_systems.fs")
	...
	for !window.ShouldClose() {
		...
		model = model.Mul4(mgl32.HomogRotate3D(-55.0*math.Pi/180, mgl32.Vec3{1.0, 0.0, 0.0}))
