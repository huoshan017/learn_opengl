...
func main() {
	...
	// -------------------------------------
	var lightingShader = gl.NewShader("4.4.lighting_maps.vs", "4.4.lighting_maps.fs")
	var lightCubeShader = gl.NewShader("4.4.light_cube.vs", "4.4.light_cube.fs")
	...
	lightingShader.SetInt32("material.emission\x00", 2)
